...
var filter = {
	methods : {
		...
		update : function (e) {
			...
			utility.clearTimers(this.element.id);
			utility.defer(function () {
...
var xhr = function () {
	...
	headers = {
		"User-Agent"   : "abaaso/3.3.13 node.js/" + process.versions.node.replace(/^v/, "") + " (" + string.capitalize(process.platform) + " V8/" + process.versions.v8 + ")",
