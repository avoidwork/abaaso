...
var promise = {
	 ...
	 * @method handler
	 * @private
	 * @param  {Function} fn    State handler
	 * @param  {Mixed}    arg   Outcome value
	 * @param  {Object}   self  Promise
	 * @param  {Object}   child Spawned Promise
	 * @return {Mixed}          Result
	 */
	handler : function ( fn, arg, self, child ) {
		var result;
...
var xhr = function () {
	...
	headers = {
		"User-Agent"   : "abaaso/3.10.0 node.js/" + process.versions.node.replace( /^v/, "" ) + " (" + string.capitalize( process.platform ) + " V8/" + process.versions.v8 + " )",
