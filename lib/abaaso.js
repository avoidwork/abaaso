...
var utility = {
	 ...
	 * @param  {Number} speed [Optional] Scrolling speed [1 - 100]
	...
	scroll : function ( x, y, speed, ease ) {
		...
		speed = !isNaN( speed ) && speed >= 1 && speed <= 100 ? speed : 100;
		ease  = ease  || null;
...
var xhr = function () {
	...
	headers = {
		"User-Agent"   : "abaaso/3.8.37 node.js/" + process.versions.node.replace( /^v/, "" ) + " (" + string.capitalize( process.platform ) + " V8/" + process.versions.v8 + " )",
