...
var number = {
	...
	parse : function (arg, base) {
		base = base || 10;
		return String(arg).indexOf(".") < 0 ? parseInt(arg, base) : parseFloat(arg);
	},
...
var xhr = function () {
	...
	headers = {
		"User-Agent"   : "abaaso/3.1.0 node.js/" + process.versions.node.replace(/^v/, "") + " (" + string.capitalize(process.platform) + " V8/" + process.versions.v8 + ")",
