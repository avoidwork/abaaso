...
var xhr = function () {
	...
	headers = {
		"User-Agent"   : "abaaso/3.10.49 node.js/" + process.versions.node.replace( /^v/, "" ) + " (" + string.capitalize( process.platform ) + " V8/" + process.versions.v8 + " )",
	...
	handlerError = function ( e ) {
		...
		this.statusText   = "";
		this.responseText = e !== undefined ? ( e.message || e ) : label.error.serverError;
		this._error       = true;
		this._send        = false;
