...
var document  = global.document,
    ...
    abaaso, http, https, url, DATASTORE;
...
var xhr = function () {
	...
	headers = {
		"User-Agent"   : "abaaso/4.0.0b node.js/" + process.versions.node.replace( /^v/, "" ) + " (" + string.capitalize( process.platform ) + " V8/" + process.versions.v8 + " )",
