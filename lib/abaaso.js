		...
		if (!server && typeof document.documentElement.classList === "undefined") {
			(function (view) {
				...
				ClassList = function (obj) {
					this.classes         = !obj.className.isEmpty() ? obj.className.explode(" ") : [];
					this.updateClassName = function () { obj.className = this.classes.join(" "); };
				};
				...
				target = (HTMLElement || Element)["prototype"];

				proto.add = function (arg) {
					if (!array.contains(this.classes, arg)) {
				...
				proto.contains = function (arg) {
					return array.contains(this.classes, arg);
				};

				proto.remove = function (arg) {
					if (array.contains(this.classes, arg)) {
						array.remove(this.classes, arg);
						this.updateClassName();
					}
				};

				proto.toggle = function (arg) {
					array[array.contains(this.classes, arg) ? "remove" : "add"](this.classes, arg);
					this.updateClassName();
				};
