...
var data = {
	...
	methods : {
		 ...
		 * @return {Object}          Data store
		 */
		delete : function (record, reindex, sync) {
			...
			switch (true) {
				...
				case this.uri === null:
					...
					break;
				case r.test(p):
					uri.delete(function () { obj.fire("syncDataDelete", args); }, function () { obj.fire("failedDataDelete", args); }, utility.merge({withCredentials: this.credentials}, this.headers));
					break;
				default:
...
var datalist = (function () {
	 ...
	 * @return {Object}  DataList instance
	 */
	factory.prototype.pages = function () {
	 ...
	 * @return {Object}        DataList instance
	 */
	factory.prototype.refresh = function (redraw) {
		redraw       = (redraw !== false);
...
var xhr = function () {
	...
	headers = {
		"User-Agent"   : "abaaso/2.9.12 node.js/" + process.versions.node.replace(/^v/, "") + " (" + string.capitalize(process.platform) + " V8/" + process.versions.v8 + ")",
