...
var array = {
	...
	diff : function (array1, array2) {
		...
		array.each(array1, function (i) { if (!array2.contains(i)) result.add(i); });
		array.each(array2, function (i) { if (!array1.contains(i)) result.add(i); });
		return result;
	},
	...
	proto : function (obj, type) {
		...
		var i,
			...
			array   : {add      : function (arg) { return array.add(this, arg); },
			           ...
			           clear    : function () { return this[0] instanceof Element ? this.each(function (i) { i.clear(); }) : array.clear(this); },
...
var xhr = function () {
	...
	headers = {
		"User-Agent"   : "abaaso/3.1.1 node.js/" + process.versions.node.replace(/^v/, "") + " (" + string.capitalize(process.platform) + " V8/" + process.versions.v8 + ")",
