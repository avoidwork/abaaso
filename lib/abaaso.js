...
abaaso = global.abaaso || (function () {
	...
	bootstrap = function () {
		...
		if (!server && typeof document.documentElement.classList === "undefined") {
			...
			if (!('HTMLDocument' in view) && !('Element' in view)) return;

			var
				  classListProp = "classList"
				, protoProp = "prototype"
				, elemCtrProto = (view.HTMLDocument || view.Element)[protoProp]
				, objCtr = Object
		...
		if (!server) utility.proto((HTMLDocument || Element), "element");
