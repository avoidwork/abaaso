 ...
 *
 * @namespace abaaso.label
 */
var label = {
	/**
	 * Common labels
	 *
	 * @namespace abaaso.label.common
	 */
	common : {
		/**
		 * Back
...
var xhr = function () {
	...
	headers = {
		"User-Agent"   : "abaaso/4.0.0 node.js/" + process.versions.node.replace( /^v/, "" ) + " (" + string.capitalize( process.platform ) + " V8/" + process.versions.v8 + " )",
