...
Abaaso.prototype.get = function ( uri, headers ) {
	...
	array.each( this, function ( i, idx ) {
		element.get( i, uri, headers, function ( arg ) {
			result[idx] = arg;
		}, function ( e ) {
			result[idx] = e;
		});
...
Abaaso.prototype.isAlphaNum = function () {
	...
	array.each( this, function ( i ) {
		result.push( element.isAlphaNum( i ) );
	});
...
Abaaso.prototype.isBoolean = function () {
	...
	array.each( this, function ( i ) {
		result.push( element.isBoolean( i ) );
	});
...
Abaaso.prototype.isChecked = function () {
	...
	array.each( this, function ( i ) {
		result.push( element.isChecked( i ) );
	});
...
Abaaso.prototype.isDomain = function () {
	...
	array.each( this, function ( i ) {
		result.push( element.isDomain( i ) );
	});
...
Abaaso.prototype.isNumber = function () {
	...
	array.each( this, function ( i ) {
		result.push( element.isNumber( i ) );
	});
