	...
	data = {
		...
		methods : {
			...
			storage : function (obj, op, type) {
				var record  = false,
				    session = (type !== "local" && typeof sessionStorage !== "undefined"),
				    ns      = /number|string/,
				    result, key, data;

				if ((typeof localStorage === "undefined" || typeof sessionStorage !== "undefined") || !/number|object|string/.test(typeof obj) || !/get|remove|set/.test(op)) throw Error(label.error.invalidArguments);
