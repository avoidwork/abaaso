...
c){0===c.indexOf(q+"_")&&u(c.replace(/.*_/,""),1)}),delete e[q],delete k[q],delete l[q]):g.each(m.explode(b),function(a){var b=!1;void 0!==e[q][a]&&(void 0===c?((s.observer_globals.test(q)||"function"===typeof q.listeners)&&u(a,g.keys(e[q][a][d]).length),e[q][a][d]={},b=!0):void 0!==e[q][a][d][c]&&(u(a,1),delete e[q][a][d][c],b=!0),b&&n.sync(q,a,d))});return a},sum:function(a){var b={};void 0!==a?(a=h.object(a),a=n.id(a),b=h.clone(n.clisteners[a])):b=h.clone(n.clisteners);return b},sync:function(a,
...
c=!0===c||443===a.port;d=function(a,c){var b=ca.parse(a.url),d=a.headers.host.replace(s.header_replace,"");v.load(b.pathname,c,a,d)};e=function(a){M(a,this,arguments);"function"===typeof b&&b(a)};v.enabled=!0;a.host=a.host||void 0;a.port=a.port||8E3;c?(Y.globalAgent.maxConnections=a.maxConnections,c=Y.createServer(a,d).on("error",e).listen(a.port)):(X.globalAgent.maxConnections=a.maxConnections||25,c=X.createServer(d).on("error",e).listen(a.port,a.host));c.maxConnections&&(c.maxConnections=a.maxConnections||
25);return c},set:function(a,b,c,d){d=y?d||"all":"all";c=y?v.method(c):"all";if("string"!==typeof a||m.isEmpty(a)||"function"!==typeof b)throw Error(t.error.invalidArguments);v.hostname(d)[c][a]=b;return!0}},F=function(){var a={current:"active",previous:null,header:null};return{getCurrent:function(){return a.current},setCurrent:function(b){if(null===b||"string"!==typeof b||a[0]===b||m.isEmpty(b))throw Error(t.error.invalidArguments);a.previous=a.current;a.current=b;n.fire(G,"state",b);return b},getHeader:function(){return a.header},
...
a?""===m.trim(a):!0},isIP:function(a){return J.test({ip:a}).pass},isInt:function(a){return J.test({integer:a}).pass},isNumber:function(a){return J.test({number:a}).pass},isPhone:function(a){return J.test({phone:a}).pass},isUrl:function(a){return J.test({url:a}).pass},singular:function(a){return s.plural.test(a)?a.slice(0,-1):a},toCamelCase:function(a){a=m.trim(a).replace(/\.|_|-|\@|\[|\]|\(|\)|\#|\$|\%|\^|\&|\*|\s+/g," ").toLowerCase().split(s.space_hyphen);var b=[];g.each(a,function(a,d){b.push(0===
...
z||void 0===a)){var c=[],d=[],e=[],c=m.explode(a);b=!0===b;g.each(c,function(a){var c;s.selector_complex.test(a)?(c=g.last(a.split(" ").filter(function(a){if(!m.isEmpty(a)&&">"!==a)return!0})),s.hash.test(c)&&!s.selector_many.test(c)?a=z.querySelector(a):(a=z.querySelectorAll(a),b||(a=g.cast(a)))):s.hash.test(a)&&!s.selector_many.test(a)?a=z.querySelector(a):(a=z.querySelectorAll(a),b||(a=g.cast(a)));null!==a&&e.push(a)});g.each(e,function(a){d=d.concat(a)});s.hash.test(a)&&(!s.selector_many.test(a)&&
!s.selector_complex.test(a))&&(d=d[0]);return d}},alias:function(a,b){h.iterate(b,function(c,d){var e;!(c instanceof RegExp)&&"function"===typeof c?a[d]=c.bind(a[d]):!(c instanceof RegExp)&&!(c instanceof Array)&&c instanceof Object?(void 0===a[d]&&(a[d]={}),h.alias(a[d],b[d])):(e=function(a){b[d]=a},h.property(a,d,{enumerable:!0,get:function(){return b[d]},set:e,value:b[d]}))});return a},clearTimers:function(a){if(void 0===a||a.isEmpty())throw Error(t.error.invalidArguments);void 0!==h.timer[a]&&
(clearTimeout(h.timer[a]),delete h.timer[a]);void 0!==h.repeating[a]&&(clearTimeout(h.repeating[a]),delete h.repeating[a])},clone:function(a){var b;return a instanceof Array?a.concat():"boolean"===typeof a?Boolean(a):"function"===typeof a?a:"number"===typeof a?Number(a):"string"===typeof a?String(a):a instanceof RegExp?a:!y&&!r.ie&&a instanceof Document?P.decode(P.encode(a)):null!==a&&void 0!==a&&"undefined"!==typeof a.__proto__?h.extend(a.__proto__,a):a instanceof Object?(b=H.encode(a,!0),void 0!==
...
"TypeError"};h.log(a.stack||a.message,!d?"error":"warn");G.error.log.push(a);n.fire(G,"error",a)},extend:function(){return"function"===typeof Object.create?function(a,b){var c;if(void 0===a)throw Error(t.error.invalidArguments);c=Object.create(a);b instanceof Object&&h.merge(c,b);return c}:function(a,b){var c;if(void 0===a)throw Error(t.error.invalidArguments);f=function(){};f.prototype=a;c=new f;b instanceof Object&&h.merge(c,b);return c}}(),genId:function(a,b){var c;if(void 0!==a&&(void 0!==a.id&&
...
function(a,b){if("function"!==typeof b)throw Error(t.error.invalidArguments);g.each(Object.keys(a),function(c){return b.call(a,a[c],c)});return a}:function(a,b){var c=Object.prototype.hasOwnProperty,d,e;if("function"!==typeof b)throw Error(t.error.invalidArguments);for(d in a)if(c.call(a,d)){if(e=b.call(a,a[d],d),!1===e)break}else break;return a}}(),loading:function(a){var b=G.loading;a=h.object(a);if(a instanceof Array)return g.each(a,function(a){h.loading(a)});if(null===b.url||void 0===a)throw Error(t.error.invalidArguments);
...
object:function(a){return"object"===typeof a?a:"#"===a.toString().charAt(0)?u(a):a},parse:function(a){var b={},c={};void 0===a&&(a=!y?N.href:"");y?b=ca.parse(a):(b=z.createElement("a"),b.href=a);y&&h.iterate(b,function(a,c){null===a&&(b[c]=void 0)});c={auth:y?null:s.auth.exec(a),protocol:b.protocol||"http:",hostname:b.hostname||"localhost",port:!m.isEmpty(b.port)?w.parse(b.port,10):"",pathname:b.pathname,search:b.search||"",hash:b.hash||"",host:b.host||"localhost"};r.ie&&(":"===c.protocol&&(c.protocol=
N.protocol),m.isEmpty(c.hostname)&&(c.hostname=N.hostname),m.isEmpty(c.host)&&(c.host=N.host),"/"!==c.pathname.charAt(0)&&(c.pathname="/"+c.pathname));c.auth=b.auth||(null===c.auth?"":c.auth[1]);c.href=b.href||c.protocol+"//"+(m.isEmpty(c.auth)?"":c.auth+"@")+c.host+c.pathname+c.search+c.hash;c.path=b.path||c.pathname+c.search;c.query=h.queryString(null,c.search);return c},property:function(){return(y||!r.ie||8<r.version)&&"function"===typeof Object.defineProperty?function(a,b,c){if(!(c instanceof
...
isUrl:function(){return l.isUrl(this)},jsonp:function(a,b,e){var k=this;return r.jsonp(a,function(a){var c=a,e=b,g;try{void 0!==e?(e=e.replace(/\]|'|"/g,"").replace(/\./g,"[").split("["),e.each(function(a){c=c[isNaN(a)?a:w.parse(a,10)];if(void 0===c)throw Error(t.error.propertyNotFound);}),g=c):g=a}catch(h){g=t.error.serverError,M(h,arguments,this)}l.html(k,g)},function(a){l.html(k,t.error.serverError);throw a;},e)},listeners:function(a){return n.list(this,a)},loading:function(){return h.loading(this)},
...
roundUp:function(){return w.round(this,"up")},un:function(a,b,e){n.remove(this.toString(),a,b,e);return this}},string:{allows:function(a){return r.allows(this,a)},capitalize:function(a){return m.capitalize(this,a)},del:function(a,b,e){return r.request(this,"DELETE",a,b,null,e)},escape:function(){return m.escape(this)},expire:function(a){return B.expire(this,a)},explode:function(a){return m.explode(this,a)},fire:function(){return n.fire.apply(n,[this].concat(g.cast(arguments)))},get:function(a,b,e){return r.request(this,
...
b.reject(c.map(function(a){return a.outcome})):b.reject(c[0].outcome))})});return b}},J={test:function(a){var b=!1,c=[],d=null,e=[],k;void 0!==a.nodeName&&"FORM"===a.nodeName?(m.isEmpty(a.id)&&h.genId(a),e=u("#"+a.id+" input","#"+a.id+" select"),g.each(e,function(a){var d={},e,g;e=s[a.nodeName.toLowerCase()]?s[a.nodeName.toLowerCase()]:!m.isEmpty(a.id)&&s[a.id.toLowerCase()]?s[a.id.toLowerCase()]:"notEmpty";g=a.val();null===g&&(g="");d[e]=g;J.test(d).pass||(c.push({element:a,test:e,value:g}),b=!0)})):
...
this._headers[a]=b;return this};return b},P={decode:function(a){try{var b;if("string"!==typeof a||m.isEmpty(a))throw Error(t.error.invalidArguments);r.ie?(b=new ActiveXObject("Microsoft.XMLDOM"),b.async="false",b.loadXML(a)):b=(new DOMParser).parseFromString(a,"text/xml");return b}catch(c){M(c,arguments,this)}},encode:function(a,b){try{if(void 0===a)throw Error(t.error.invalidArguments);var c=(b=!1!==b)?"<xml>":"",d=!1!==arguments[2],e;null!==a&&void 0!==a.xml&&(a=a.xml);a instanceof Document&&(a=
...
d)},patch:function(a,b,c,d,e,g){return r.request(a,"PATCH",b,c,d,e,g)},post:function(a,b,c,d,e,g){return r.request(a,"POST",b,c,d,e,g)},put:function(a,b,c,d,e,g){return r.request(a,"PUT",b,c,d,e,g)},jsonp:function(a,b,c,d){return r.jsonp(a,b,c,d)},options:function(a,b,c,d){return r.request(a,"OPTIONS",b,c,null,null,d)},permissions:r.permissions},cookie:U,element:l,json:H,label:t,loading:{create:h.loading,url:null},message:{clear:function(a){return n.remove(D,"message","message",a||"all")},send:function(a,
b){try{a.postMessage(b,"*")}catch(c){M(c,arguments,this)}return a},recv:function(a,b){return n.add(D,"message",a,"message",D,b||"all")}},mouse:W,number:w,regex:s,route:{enabled:!1,current:v.current,del:v.del,hash:v.hash,init:v.init,initial:v.initial,list:v.list,load:v.load,reset:v.reset,server:v.server,set:v.set},state:{},string:m,xml:P,$:h.$,alias:h.alias,aliased:"abaaso",allows:r.allows,append:function(a,b,c){c instanceof Element&&c.genId();return l.create(a,b,c,"last")},bootstrap:function(){var a=
this,b,c;delete G.bootstrap;b=function(a){n.remove(a);g.each(g.cast(a.childNodes),function(a){b(a)})};c=function(b){if(s.complete_loaded.test(z.readyState))return"function"===typeof a.init&&a.init.call(a),!1};if(y)delete this.cookie,this.array.cast=g.cast(),this.property=h.property=h.property(),XMLHttpRequest=fa();else{this.client.size=r.size();this.client.version=r.version=r.version();this.client.mobile=r.mobile.call(this);this.client.tablet=r.tablet.call(this);if(r.ie&&8>r.version)throw Error(t.error.upgrade);
...
h.proto(Number,"number");h.proto(String,"string");u.error.log=this.error.log=[];y||(n.add(D,"error",function(a){n.fire(G,"error",a)},"error",D,"all"),n.add(D,"hashchange",function(b){b=N.hash.replace(/^\#\!?|\?.*|\#.*/g,"");if(u.route.current!==b||a.route.current!==b)a.route.current=b,u.route.current!==a.route.current&&(u.route.current=a.route.current),n.fire(G,"beforeHash, hash, afterHash",N.hash)},"hash",D,"all"),n.add(D,"resize",function(b){u.client.size=a.client.size=r.size();n.fire(G,"resize",
a.client.size)},"resize",D,"all"),n.add(D,"load",function(a){n.fire(G,"render");n.remove(G,"render");n.remove(this,"load")}),"function"===typeof Object.observe&&n.add(D,"DOMNodeInserted",function(a){var b=h.target(a);Object.observe(b,function(a){n.fire(b,"change",a)})},"mutation",D,"all"),n.add(D,"DOMNodeRemoved",function(a){var c=h.target(a);void 0!==c.id&&(!m.isEmpty(c.id)&&a.relatedNode instanceof Element)&&b(c)},"mutation",D,"all"),n.add(G,"hash",function(b){(u.route.enabled||a.route.enabled)&&
v.load(b)},"route",this.route,"all"));!r.ie||8<r.version?(h.property(this.state,"current",{enumerable:!0,get:F.getCurrent,set:F.setCurrent}),h.property(this.state,"previous",{enumerable:!0,get:F.getPrevious,set:F.setPrevious}),h.property(this.state,"header",{enumerable:!0,get:F.getHeader,set:F.setHeader}),h.property(u.state,"current",{enumerable:!0,get:F.getCurrent,set:F.setCurrent}),h.property(u.state,"previous",{enumerable:!0,get:F.getPrevious,set:F.setPrevious}),h.property(u.state,"header",{enumerable:!0,
