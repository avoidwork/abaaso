...
~c:y.items[a][b]=c;return y.items[a]}},q={activex:function(){var a=!1;if("undefined"!==typeof ActiveXObject)try{new ActiveXObject("Microsoft.XMLHTTP"),a=!0}catch(b){}return a}(),android:!w&&s.android.test(E.userAgent),blackberry:!w&&s.blackberry.test(E.userAgent),chrome:!w&&s.chrome.test(E.userAgent),firefox:!w&&s.firefox.test(E.userAgent),ie:!w&&s.ie.test(E.userAgent),ios:!w&&s.ios.test(E.userAgent),linux:!w&&s.linux.test(E.userAgent),mobile:function(){return!w&&(/blackberry|iphone|webos/i.test(E.userAgent)||
s.android.test(E.userAgent)&&(720>this.client.size.height||720>this.client.size.width))},playbook:!w&&s.playbook.test(E.userAgent),opera:!w&&s.opera.test(E.userAgent),osx:!w&&s.osx.test(E.userAgent),safari:!w&&s.safari.test(E.userAgent.replace(/chrome.*/i,"")),tablet:function(){return!w&&(/ipad|playbook|webos/i.test(E.userAgent)||s.android.test(E.userAgent)&&(720<=this.client.size.width||720<=this.client.size.width))},webos:!w&&s.webos.test(E.userAgent),windows:!w&&s.windows.test(E.userAgent),version:function(){var a=
...
[],this.depth=0,this.events=!0,this.expires=null,this.headers={Accept:"application/json"},this.ignore=[],this.key=null,this.keys={},this.leafs=[],this.loaded=!1,this.maxDepth=0,this.pointer=null,this.records=[],this.retrieve=this.recursive=!1,this.source=null,this.total=0,this.views={},this.uri=null,b&&m.fire(this.parentNode,"afterDataClear"));return this},crawl:function(a){var b=this,c=!0===this.events,d=a instanceof Object?a:this.get(a),e=null===this.uri?"":this.uri,k=I.factory(),n=0,r=0,p,h,l;
if(void 0===d)throw Error(t.error.invalidArguments);this.crawled=!0;p=function(a,b){var c="";s.double_slash.test(a)?c=a:"/"===a.charAt(0)&&"/"!==b.charAt(0)?(c=g.parse(b),c=c.protocol+"//"+c.host+a):c=a;return c};h=function(){++n===r&&k.resolve(r)};l=function(a,b){var c={};f.contains(b.collections,a)||b.collections.push(a);c=T.decorator({id:d.key+"-"+a},null,{key:b.key,pointer:b.pointer,source:b.source,ignore:g.clone(b.ignore),leafs:g.clone(b.leafs),depth:b.depth+1,maxDepth:b.maxDepth});c.data.headers=
g.merge(c.data.headers,b.headers);!f.contains(b.leafs,a)&&(b.recursive&&b.retrieve&&(0===c.data.maxDepth||c.data.depth<c.data.maxDepth))&&(c.data.recursive=!0,c.data.retrieve=!0);return c};g.iterate(d.data,function(a,k){var n;if(!(f.contains(b.ignore,k)||f.contains(b.leafs,k)||b.depth>=b.maxDepth||!(a instanceof Array)&&"string"!==typeof a))if(r=f.cast(d.data).length,n=I.factory(),n.then(function(a){c&&m.fire(d.data[k],"afterDataRetrieve",a);h()},function(a){c&&m.fire(d.data[k],"failedDataRetrieve",
a);h()}),a instanceof Array&&0<a.length)d.data[k]=l(k,b),"string"===typeof a[0]&&f.each(a,function(b,c){a[c]=p(b,e)}),d.data[k].data.batch("set",a,!0,void 0).then(function(a){n.resolve(a)},function(a){n.reject(a)});else if("/"===a.charAt(0)||-1<a.indexOf("//"))d.data[k]=l(k,b),a=p(a,e),d.data[k].data.setUri(a).then(function(a){n.resolve(a)},function(a){n.reject(a)})});return k},del:function(a,b,c){if(void 0===a||!s.number_string.test(typeof a))throw Error(t.error.invalidArguments);b=!1!==b;c=!0===
c;var d=this,e=!0===this.events,k=I.factory(),n=I.factory(),r,p,h,l;k.then(function(a){var b=d.get(a.record);d.records.remove(d.keys[a.key]);delete d.keys[a.key];d.total--;d.views={};g.iterate(b.data,function(a){null!==a&&void 0!==a.data&&"function"===typeof a.data.teardown&&a.data.teardown()});a.reindex&&d.reindex();c||(d.autosave&&d.save(),f.each(d.datalists,function(a){a.del(b)}));e&&m.fire(d.parentNode,"afterDataDelete",b);n.resolve(b)},function(a){e&&m.fire(d.parentNode,"failedDataDelete",a);
n.reject(a)});if("string"===typeof a){if(r=a,a=this.keys[r],void 0===a)throw Error(t.error.invalidArguments);}else{r=this.records[a];if(void 0===r)throw Error(t.error.invalidArguments);r=r.key}p={key:r,record:a,reindex:b};c||(null!==this.callback||null===this.uri)||(h=this.uri+"/"+r,l=q.cors(h)||q.allows(h,"delete"));e&&m.fire(d.parentNode,"beforeDataDelete",p);c||null!==this.callback||null===this.uri?k.resolve(p):s.true_undefined.test(l)?q.request(h,"DELETE",function(){k.resolve(p)},function(a){k.reject(a)},
...
var d=[],e=[],k=RegExp(),n="function"===typeof a;if(0===this.total)return d;n||(a="string"===typeof a?l.explode(a):[a],void 0===c||l.isEmpty(c)?c="gi":null===c&&(c=""));b="string"===typeof b?l.explode(b):null;null===b?f.each(this.records,function(b){n?!0===a(b)&&(e.push(b.key),d.push(b)):g.iterate(b.data,function(n){if(f.contains(e,b.key))return!1;null!==n&&"object"!==typeof n.data&&f.each(a,function(a){g.compile(k,a,c);if(k.test(n))return e.push(b.key),d.push(b),!1})})}):f.each(this.records,function(r){f.each(b,
function(b){if(f.contains(e,r.key))return!1;if(void 0!==r.data[b]&&"object"!==typeof r.data[b].data)if(!n)f.each(a,function(a){g.compile(k,a,c);if(k.test(r.data[b]))return e.push(r.key),d.push(r),!1});else if(!0===a(r.data[b]))return e.push(r.key),d.push(r),!1})});return d},form:function(a,b,c){c=!1!==c;var d=null===a,e=this,k,n,r,p;d?a=this.get(0):a instanceof Object||(a=this.get(a));if(void 0===a)throw Error(t.error.invalidArguments);if(null!==this.uri&&!q.cors(this.uri)&&!q.allows(this.uri,"post"))throw Error(t.error.serverInvalidMethod);
r=a.key;p=a.data;void 0!==b&&(b=g.object(b));null!==this.uri?(a=this.uri.replace(s.not_endpoint,"").replace(/\?.*/,""),l.isDomain(a)&&(a=a.replace(/\..*/g,""))):a="record";k=function(a){var b=g.target(a).parentNode,d=g.$("#"+b.id+" input"),k=d[0].name.match(/(.*)\[/)[1],n=!0,p={};g.stop(a);c&&(n=h.validate(b));n&&(f.each(d,function(a){void 0!==a.type&&s.input_button.test(a.type)||g.define(a.name.replace("[",".").replace("]",""),a.value,p)}),e.set(r,p[k]).then(function(){h.destroy(b)},function(){h.destroy(b)}))};
...
d&&-1<a.indexOf(",")?(k=[],f.each(l.explode(a),function(a){isNaN(a)||(a=u.parse(a,10));k.push(e.get(a))})):"string"===d&&void 0!==this.keys[a]?k=c[this.keys[a]]:"number"===d&&void 0===b?k=c[u.parse(a,10)]:"number"===d&&"number"===typeof b&&(k=c.limit(u.parse(a,10),u.parse(b,10)));return k},join:function(a,b,c){c=c||"inner";var d=this,e=[],k=b===this.key,n=f.merge(f.cast(this.records[0].data,!0),f.cast(a.data.records[0].data,!0)),r;"inner"===c?r=function(c){var d={};d[b]=k?c.key:c.data[b];d=a.data.select(d);
if(2<d.length)throw Error(t.error.databaseMoreThanOne);1===d.length&&e.push(g.merge(g.clone(c.data),g.clone(d[0].data)))}:"left"===c?r=function(c){var d={},r=g.clone(c.data);d[b]=k?c.key:c.data[b];c=a.data.select(d);if(2<c.length)throw Error(t.error.databaseMoreThanOne);1===c.length?e.push(g.merge(g.clone(r),g.clone(c[0].data))):(f.each(n,function(a){void 0===r[a]&&(r[a]=null)}),e.push(r))}:"right"===c&&(r=function(a){var c={},r=g.clone(a.data);c[b]=k?a.key:a.data[b];a=d.select(c);if(2<a.length)throw Error(t.error.databaseMoreThanOne);
1===a.length?e.push(g.merge(g.clone(r),g.clone(a[0].data))):(f.each(n,function(a){void 0===r[a]&&(r[a]=null)}),e.push(r))});f.each("right"===c?a.data.records:this.records,r);return e},only:function(a){return a===this.key?this.records.map(function(a){return a.key}):this.records.map(function(b){return b.data[a]})},purge:function(a){return this.storage(a||this,"remove")},reindex:function(){var a=this.total,b=-1;this.views={};if(0<a)for(;++b<a;)this.records[b].index=b,this.keys[this.records[b].key]=b;
return this},restore:function(a){return this.storage(a||this,"get")},save:function(a){return this.storage(a||this,"set")},select:function(a){if(!(a instanceof Object))throw Error(t.error.invalidArguments);return this.records.filter(function(b){var c=!0;g.iterate(a,function(a,e){var f=typeof a;if("function"!==f&&b.data[e]!==a||"function"===f&&!a(b.data[e],b))return c=!1});return c})},set:function(a,b,c){c=!0===c;var d=this,e=I.factory(),k=I.factory(),n=!1,r,h,l,J,A,L,C;if(!(b instanceof Object))throw Error(t.error.invalidArguments);
C=function(a,b){k[a?"resolve":"reject"](b)};e.then(function(a){var b=null,e=a.key,k=a.record,n=a.result,r=I.factory(),h,b=g.clone(a.data);r.then(function(a){d.retrieve&&d.crawl(a);c||(d.autosave&&d.save(e),f.each(d.datalists,function(a){a.refresh()}));l&&m.fire(d.parentNode,"afterDataSet",a);C(!0,a)},function(a){l&&m.fire(d.parentNode,"failedDataSet",a);C(!1,a)});d.views={};void 0!==e&&(k=d.get(e));if(void 0===k)if(a=d.total++,void 0===e&&(void 0===n&&(d.total--,r.reject(t.error.expectedObject)),
null!==d.source&&(n=g.walk(n,d.source)),null===d.key?e=g.uuid():(e=n[d.key],delete n[d.key]),"string"!==typeof e&&(e=e.toString()),b=n),d.keys[e]=a,d.records[a]={key:e,data:{},index:a},h=d.records[a],null===d.pointer||void 0===b[d.pointer])h.data=b,null!==d.key&&h.data.hasOwnProperty(d.key)&&delete h.data[d.key],r.resolve(h);else{b=b[d.pointer];if(void 0===b||null===b)delete d.records[a],delete d.keys[e],r.reject(t.error.expectedObject);h.data={};q.request(b,"GET",function(a){null!==d.source&&(a=
g.walk(a,d.source));void 0!==a[d.key]&&delete a[d.key];h.data=a;r.resolve(h)},function(a){r.reject(a)},d.headers)}else h=d.records[d.keys[k.key]],h.data=b,r.resolve(h);return h},function(a){l&&m.fire(d.parentNode,"failedDataSet",a);throw a;});a instanceof Object&&(c=b,b=a,a=null);r=g.clone(b);null===a&&null===this.uri?null===this.key||void 0===r[this.key]?a=g.uuid():(a=r[this.key],delete r[this.key]):null===a&&(a=void 0);if(r instanceof Array)return this.generate(a).then(function(){d.get(a).data.batch("set",
r).then(function(a){e.resolve(a)},function(a){e.reject(a)})});b=void 0===a?void 0:this.get(a);h=void 0===a?"post":"put";l=!0===this.events;J={data:{},key:a,record:void 0};A=this.uri;c||(null!==this.callback||null===A)||(void 0!==b&&A.replace(s.not_endpoint,"")!==b.key&&(A+="/"+b.key),"put"===h&&(q.allows(A,"patch")&&(!q.ie||8<q.version||q.activex))&&(h="patch",L=n=!0),void 0===L&&(L=q.cors(A)||q.allows(A,h)));void 0!==b?(J.record=this.records[this.keys[b.key]],g.iterate(J.record.data,function(a,b){f.contains(d.ignore,
b)||(J.data[b]=a)}),g.merge(J.data,r),n||(r=J.data)):J.data=r;l&&m.fire(d.parentNode,"beforeDataSet",{key:a,data:r});c||null!==this.callback||null===this.uri?e.resolve(J):s.true_undefined.test(L)?q.request(A,h.toUpperCase(),function(a){J.result=a;e.resolve(J)},function(a){e.reject(a)},r,g.merge({withCredentials:this.credentials},this.headers)):e.reject(J);return k},setExpires:function(a){if(null!==a&&null===this.uri||null!==a&&(isNaN(a)||1E3>a))throw Error(t.error.invalidArguments);if(this.expires!==
...
!0),this.sync(!0).then(function(a){b.resolve(a)},function(a){b.reject(a)})));return b},sort:function(a,b,c,d){if(void 0===a||l.isEmpty(a))throw Error(t.error.invalidArguments);s.sensitivity_types.test(c)||(c="ci");a=a.replace(/\s*asc/ig,"");b=!0===b||d instanceof Object;a=l.explode(a);var e=a.join(" ").toCamelCase()+c.toUpperCase(),k=this.key,n=[],r,h,m,q;h=function(a,b){var c=g.clone(a),d=a[0],e={},k=[];f.remove(c,0);e=r(d,b,s.desc.test(d));f.each(e.order,function(a){2>e.registry[a].length||0<c.length&&
(e.registry[a]=h(c,e.registry[a]))});f.each(e.order,function(a){k=k.concat(e.registry[a])});return k};r=function(a,b,d){var e=a.replace(s.desc,""),n=k===e,g=[],h={};f.each(b,function(a){var b=n?a.key:a.data[e],b=null===b?"null":b.toString();"ci"===c?b=l.toCamelCase(b):"cs"===c?b=l.trim(b):"ms"===c&&(b=l.trim(b).slice(0,1).toLowerCase());h[b]instanceof Array||(h[b]=[],g.push(b));h[b].push(a)});g.sort(q);d&&g.reverse();f.each(g,function(b){1!==h[b].length&&(h[b]=m(h[b],a,e,d,n))});return{order:g,registry:h}};
m=function(a,b,c,d,e){var k=[];b=[];f.each(a,function(a,b){var d=e?a.key:a.data[c]||"!",d=l.trim(d.toString())+":::"+b;k.push(d)});1<k.length&&(k.sort(q),d&&k.reverse(),b=k.map(function(b){return a[b.replace(s.sort_needle,"")]}));return b};q=function(a,b){a=a.replace(s.sort_value,"");b=b.replace(s.sort_value,"");return f.sort(u.parse(a)||a,u.parse(b)||b)};if(!b&&this.views[e]instanceof Array)return this.views[e];if(0===this.total)return[];n=h(a,void 0===d?this.records:this.select(d));return this.views[e]=
n},storage:function(a,b,c){var d=this,e=!1,k=!l.isEmpty(this.mongodb);c="session"===c&&"undefined"!==typeof sessionStorage;var n=I.factory(),h,p;if(!s.number_string_object.test(typeof a)||!s.get_remove_set.test(b))throw Error(t.error.invalidArguments);e=s.number_string.test(typeof a)||a.hasOwnProperty("key")&&!a.hasOwnProperty("parentNode");!e||a instanceof Object||(a=this.get(a));p=e?a.key:a.parentNode.id;if("get"===b)if(k)mongodb.connect(this.mongodb,function(b,c){b?(n.reject(b),c.close()):c.createCollection(d.parentNode.id,
...
page:function(a){if(isNaN(a))throw Error(t.error.invalidArguments);this.pageIndex=a;this.refresh();return this},pages:function(){var a=this.element,b=this.pageIndex,c=this.pagination,d=this.pageRange,e=u.round(u.half(d),"down"),k=b-e,n=b+e,r=this,p=S.pages.call(this);if(!s.top_bottom.test(c))throw Error(t.error.invalidArguments);f.each(g.$("#"+a.id+"-pages-top, #"+a.id+"-pages-bottom"),function(a){void 0!==a&&h.destroy(a)});if(0===this.total||1===p)return this;1>k&&(e=u.diff(k,1),k+=e,n+=e);n>p&&
...
function(b,c){var d,e;f.contains(q,a.key)||(b=l.explode(b),d=RegExp(),e=c===n.store.key,f.each(b,function(b){g.compile(d,b,"i");if(e&&d.test(a.key)||void 0!==a.data[c]&&d.test(a.data[c]))return q.push(a.key),k.push({key:a.key,template:t(a)}),!1}))}):k.push({key:a.key,template:t(a)})});this.records=k;this.total=k.length;if("number"===typeof this.pageIndex&&"number"===typeof this.pageSize){d=S.pages.call(this);if(0<d&&this.pageIndex>d)return this.page(d);0<this.total&&(e=S.range.call(this),k=k.limit(e[0],
e[1]))}a?(h.clear(c),0===this.total?h.create("li",{innerHTML:this.emptyMsg,"class":"empty"},c):f.each(k,function(a){var b=g.tpl(a.template,c);h.data(b,"key",a.key);r&&n.callback(b)})):(f.each(h.find(c,"> li"),function(a){h.addClass(a,"hidden")}),f.each(k,function(a){f.each(h.find(c,"> li[data-key='"+a.key+"']"),function(a){h.removeClass(a,"hidden")})}));s.top_bottom.test(this.pagination)&&"number"===typeof this.pageIndex&&"number"===typeof this.pageSize?this.pages():f.each(g.$("#"+c.id+"-pages-top, #"+
...
b,c){if(s.svg.test(a.namespaceURI))void 0===c?(c=a.getAttributeNS(a.namespaceURI,b),null===c||l.isEmpty(c)||g.coerce(c)):a.setAttributeNS(a.namespaceURI,b,c);else{"string"===typeof c&&(c=l.trim(c));if(s.checked_disabled.test(b)&&void 0===c)return g.coerce(a[b]);if(s.checked_disabled.test(b)&&void 0!==c)a[b]=c;else{if("SELECT"===a.nodeName&&"selected"===b&&void 0===c)return g.$("#"+a.id+' option[selected="selected"]')[0]||g.$("#"+a.id+" option")[0];if("SELECT"===a.nodeName&&"selected"===b&&void 0!==
...
!1,k;if(void 0===a||l.isEmpty(a))throw Error(t.error.invalidArguments);if(void 0!==c){c=g.object(c);if(void 0===c)throw Error(t.error.invalidArguments);e=void 0!==c.namespaceURI&&s.svg.test(c.namespaceURI)}else c=x.body;b instanceof Object&&void 0!==b.id&&void 0===g.$("#"+b.id)?(k=b.id,delete b.id):e||(k=g.genId(void 0,!0));a=e||s.svg.test(a)?x.createElementNS("http://www.w3.org/2000/svg",a):x.createElement(a);void 0!==k&&(a.id=k);b instanceof Object&&h.update(a,b);void 0===d||"last"===d?c.appendChild(a):
...
void 0!==a.textContent?"textContent":"innerText",d={},e=!1;"undefined"!==typeof b&&(e=!0,d[c]=b);return e?h.update(a,d):a[c]},toggleClass:function(a,b){a.classList.toggle(b);return a},update:function(a,b){b=b||{};g.iterate(b,function(b,d){if(s.element_update.test(d))a[d]=b;else if("class"===d)l.isEmpty(b)?h.klass(a,"*",!1):h.klass(a,b);else if(0===d.indexOf("data-"))h.data(a,d.replace("data-",""),b);else if("id"===d){var e=m.listeners;void 0!==e[a.id]&&(e[d]=g.clone(e[a.id]),delete e[a.id])}else h.attr(a,
d,b)});return a},val:function(a,b){var c="input",d;if(void 0===b){if(s.radio_checkbox.test(a.type)){if(l.isEmpty(a.name))throw Error(t.error.expectedProperty);f.each(g.$("input[name='"+a.name+"']"),function(a){if(a.checked)return d=a.value,!1})}else d=s.select.test(a.type)?a.options[a.selectedIndex].value:a.value||h.text(a);void 0!==d&&(d=g.coerce(d));"string"===typeof d&&(d=l.trim(d))}else b=b.toString(),s.radio_checkbox.test(a.type)?(c="click",f.each(g.$("input[name='"+a.name+"']"),function(a){if(a.value===
b)return a.checked=!0,d=a,!1})):s.select.test(a.type)?(c="change",f.each(h.find(a,"> *"),function(a){if(a.value===b)return a.selected=!0,d=a,!1})):void 0!==a.value?a.value=b:h.text(a,b),h.dispatch(a,c),d=a;return d},validate:function(a){return"FORM"===a.nodeName?K.test(a):!l.isEmpty(a.value||h.text(a))}},ga={factory:function(a,b,c,d){d=d||250;var e=[b];if(!(a instanceof Element)||void 0!==b&&void 0===b.store||"string"!==typeof c||l.isEmpty(c))throw Error(t.error.invalidArguments);return(new Z(a,e[0],
...
return a},discard:function(a){return void 0===a?m.ignore:m.ignore=!0===a},fire:function(a,b){a=g.object(a);var c=!1,d=f.cast(arguments).remove(0,1),e,k,n,h;if(m.ignore)return a;if(a instanceof Array)return f.each(a,function(a){m.fire.apply(m,[a,b].concat(d))}),a;e=m.id(a);if(void 0===e||void 0===b)throw Error(t.error.invalidArguments);m.silent?m.queue.push({obj:a,event:b}):(k=F.getCurrent(),n=B.logging,f.each(l.explode(b),function(b){n&&g.log(e+" firing "+b);h=m.list(a,b,m.alisteners);void 0!==h.all&&
f.each(h.all,function(a){a=a.fn.apply(a.scope,d);if(!1===a)return c=!0,a});c||("all"===k||void 0===h[k])||f.each(h[k],function(a){return a.fn.apply(a.scope,d)})}));return a},id:function(a){a===D?a="window":w||a!==x?w||a!==x.body?(g.genId(a),a=a.id||("function"===typeof a.toString?a.toString():a)):a="body":a="document";return a},list:function(a,b,c){a=g.object(a);c=c||m.listeners;a=m.id(a);return void 0===c[a]&&void 0===b?{}:void 0===c[a]||void 0!==b&&!l.isEmpty(b)?void 0!==c[a]&&void 0!==c[a][b]?
c[a][b]:{}:c[a]},once:function(a,b,c,d,e,k){var n=d||g.genId();a=g.object(a);e=e||a;k=k||F.getCurrent();if(void 0===a||null===b||void 0===b||"function"!==typeof c)throw Error(t.error.invalidArguments);if(a instanceof Array)return f.each(a,function(a){m.once(a,b,c,d,e,k)}),a;m.add(a,b,function(){c.apply(e,arguments);m.remove(a,b,n,k)},n,e,k);return a},pause:function(a){!0===a?m.silent=a:!1===a&&(m.silent=a,f.each(m.queue,function(a){m.fire(a.obj,a.event)}),m.queue=[]);return a},remove:function(a,b,
c,d){a=g.object(a);d=d||F.getCurrent();if(a instanceof Array)return f.each(a,function(a){m.remove(a,b,c,d)});var e=m.listeners,k=m.alisteners,n=m.elisteners,h=m.clisteners,p=m.id(a),q="function"===typeof a.addEventListener,t="object"===typeof a.attachEvent||q,u;u=function(b,c){"number"===typeof c&&0===(h[p][b]-=c)&&t&&(a[q?"removeEventListener":"detachEvent"]((q?"":"on")+b,n[p+"_"+b],!1),delete n[p+"_"+b])};if(void 0===e[p])return a;void 0===b||null===b?((s.observer_globals.test(p)||"function"===
typeof p.listeners)&&g.iterate(n,function(a,b){0===b.indexOf(p+"_")&&u(b.replace(/.*_/,""),1)}),delete e[p],delete k[p],delete h[p]):f.each(l.explode(b),function(a){var b=!1;void 0!==e[p][a]&&(void 0===c?((s.observer_globals.test(p)||"function"===typeof p.listeners)&&u(a,f.keys(e[p][a][d]).length),e[p][a][d]={},b=!0):void 0!==e[p][a][d][c]&&(u(a,1),delete e[p][a][d][c],b=!0),b&&m.sync(p,a,d))});return a},sum:function(a){var b={};void 0!==a?(a=g.object(a),a=m.id(a),b=g.clone(m.clisteners[a])):b=g.clone(m.clisteners);
return b},sync:function(a,b,c){m.alisteners[a][b][c]=f.cast(m.listeners[a][b][c])}},z={delay:function(){return"undefined"!==typeof setImmediate?setImmediate:"undefined"!==typeof process?process.nextTick:g.defer},factory:function(){return new Q},freeze:"function"===typeof Object.freeze,methods:{reject:function(a){var b=this;z.delay(function(){z.resolve.call(b,z.state.broken,a)});return this},resolve:function(a){var b=this;z.delay(function(){z.resolve.call(b,z.state.resolved,a)});return this},resolved:function(){return this.state===
z.state.broken||this.state===z.state.resolved},then:function(a,b){var c=this,d=z.factory(),e;e=function(e){var h=e?a:b;e=e?!1:!0;var r;try{r=h.call(void 0,c.outcome),e=!1}catch(p){r=p,e=!0,void 0===r||(null===r||r instanceof Error)||("object"===typeof r&&(r=H.encode(r)),r=Error(r)),g.error(r,[c.outcome],c)}finally{if(r instanceof Q)c.state=z.state.pending,c.outcome=null,r.parentNode=c,r.then(function(a){f.each(c.childNodes,function(b){b.resolve(a)})},function(a){f.each(c.childNodes,function(b){b.reject(a)})});
else{if(e&&void 0===r)throw Error(t.error.invalidArguments);d[e?"reject":"resolve"](r||c.outcome)}return r}};"function"===typeof a&&z.vouch.call(this,z.state.resolved,function(){return e(!0)});"function"===typeof b&&z.vouch.call(this,z.state.broken,function(){return e(!1)});d.parentNode=c;c.childNodes.push(d);return d}},resolve:function(a,b){var c=a===z.state.broken?"error":"fulfill",d=this,e=!1,k=!1,g=[],h,p,l;if(this.state!==z.state.pending){if(null!==this.parentNode&&this.parentNode.state===z.state.resolved||
0<this.childNodes.length)return;throw Error(t.error.promiseResolved.replace("{{outcome}}",this.outcome));}this.state=a;this.outcome=b;f.each(this[c],function(c,f){l=c.call(d,b);g.push(f);if(l instanceof Q)return e=!0,d.outcome=null,d.state=z.state.pending,!1;l instanceof Error&&(k=!0,p=l,a=z.state.broken)});if(e){for(h=g.length;h--;)f.remove(d[c],g[h]);return l}this.error=[];this.fulfill=[];k||(l=p,a=z.state.resolved);if(null!==this.parentNode&&this.parentNode.state===z.state.pending)this.parentNode[a===
z.state.resolved?"resolve":"reject"](l||this.outcome);z.freeze&&Object.freeze(this);return this},state:{broken:"rejected",pending:"pending",resolved:"fulfilled"},vouch:function(a,b){if(l.isEmpty(a))throw Error(t.error.invalidArguments);this.state===z.state.pending?this[a===z.state.resolved?"fulfill":"error"].push(b):this.state===a&&b(this.outcome);return this}};Q.prototype=z.methods;Q.prototype.constructor=Q;var ha={array:{add:function(a){return f.add(this,a)},addClass:function(a){return f.each(this,
...
a,b,c,d||this,e);return this},random:function(){return u.random(this)},round:function(){return u.round(this)},roundDown:function(){return u.round(this,"down")},roundUp:function(){return u.round(this,"up")},un:function(a,b,c){m.remove(this.toString(),a,b,c);return this}},string:{allows:function(a){return q.allows(this,a)},capitalize:function(a){return l.capitalize(this,a)},del:function(a,b,c){return q.request(this,"DELETE",a,b,null,c)},escape:function(){return l.escape(this)},expire:function(a){return y.expire(this,
...
singular:function(a){return s.plural.test(a)?a.slice(0,-1):a},toCamelCase:function(a){a=l.trim(a).replace(/\.|_|-|\@|\[|\]|\(|\)|\#|\$|\%|\^|\&|\*|\s+/g," ").toLowerCase().split(s.space_hyphen);var b=[];f.each(a,function(a,d){b.push(0===d?a:l.capitalize(a))});return b.join("")},trim:function(a){return a.toString().replace(/^(\s+|\t+)|(\s+|\t+)$/g,"")},unCamelCase:function(a){return l.trim(a.replace(/([A-Z])/g," $1").toLowerCase())},uncapitalize:function(a){a=l.trim(a);return a.charAt(0).toLowerCase()+
a.slice(1)},unhyphenate:function(a,b){b=!0===b;var c="";-1<a.indexOf("-")?f.each(l.trim(a).split("-"),function(a){c+=(b?l.capitalize(a):a)+" "}):c=b?l.capitalize(a):a;return l.trim(c)}},g={timer:{},repeating:{},$:function(a){var b;if(void 0!==a)return a=l.trim(a),-1===a.indexOf(",")?b=!s.selector_complex.test(a)&&s.hash.test(a)?x.getElementById(a.replace(s.hash,""))||void 0:f.cast(x.querySelectorAll(a)):(b=[],f.each(l.explode(a),function(a){!s.selector_complex.test(a)&&s.hash.test(a)?(a=x.getElementById(a.replace(s.hash,
...
g.timer[a]&&(clearTimeout(g.timer[a]),delete g.timer[a]);void 0!==g.repeating[a]&&(clearTimeout(g.repeating[a]),delete g.repeating[a])},clone:function(a){var b;return a instanceof Array?a.slice():"boolean"===typeof a?Boolean(a):"function"===typeof a?a:"number"===typeof a?Number(a):"string"===typeof a?String(a):a instanceof RegExp?a:!w&&!q.ie&&a instanceof Document?P.decode(P.encode(a)):null!==a&&void 0!==a&&"undefined"!==typeof a.__proto__?g.extend(a.__proto__,a):a instanceof Object?(b=H.encode(a,
!0),void 0!==b?(b=H.decode(b),g.iterate(a,function(a,d){"function"===typeof a&&(b[d]=a)})):b=a,b):a},coerce:function(a){a=g.clone(a);var b;l.isEmpty(a)?a=void 0:"undefined"===a?a=void 0:"null"===a?a=null:s.string_boolean.test(a)?a=s.string_true.test(a):(b=H.decode(a,!0))&&void 0!==b?a=b:null===a||(void 0===a||isNaN(Number(a)))||(a=Number(a));return a},compile:function(a,b,c){a.compile(b,c);return!0},css:function(a,b){var c,d;c=h.create("style",{type:"text/css",media:b||"print, screen"},g.$("head")[0]);
...
Object?g.iterate(b,function(b,c){a[d][c]=g.clone(b)}):a[d]=g.clone(b)});return a},module:function(a,b){if(void 0!==B[a]||!b instanceof Object)throw Error(t.error.invalidArguments);B[a]=b;return B[a]},object:function(a){return"object"===typeof a?a:"#"===a.toString().charAt(0)?g.$(a):a},parse:function(a){var b={},c={};void 0===a&&(a=w?"":O.href);w?b=ba.parse(a):(b=x.createElement("a"),b.href=a);w&&g.iterate(b,function(a,c){null===a&&(b[c]=void 0)});c={auth:w?null:s.auth.exec(a),protocol:b.protocol||
"http:",hostname:b.hostname||"localhost",port:l.isEmpty(b.port)?"":u.parse(b.port,10),pathname:b.pathname,search:b.search||"",hash:b.hash||"",host:b.host||"localhost"};q.ie&&(":"===c.protocol&&(c.protocol=O.protocol),l.isEmpty(c.hostname)&&(c.hostname=O.hostname),l.isEmpty(c.host)&&(c.host=O.host),"/"!==c.pathname.charAt(0)&&(c.pathname="/"+c.pathname));c.auth=b.auth||(null===c.auth?"":c.auth[1]);c.href=b.href||c.protocol+"//"+(l.isEmpty(c.auth)?"":c.auth+"@")+c.host+c.pathname+c.search+c.hash;c.path=
b.path||c.pathname+c.search;c.query=g.queryString(null,c.search);return c},property:function(){return(w||!q.ie||8<q.version)&&"function"===typeof Object.defineProperty?function(a,b,c){if(!(c instanceof Object))throw Error(t.error.invalidArguments);void 0!==c.value&&void 0!==c.get&&delete c.value;Object.defineProperty(a,b,c)}:function(a,b,c){if(!(c instanceof Object))throw Error(t.error.invalidArguments);a[b]=c.value;return a}},proto:function(a,b){g.iterate(ha[b],function(b,d){g.property(a.prototype,
...
function(a){a=a||null;var b=this,c,f;if(1>this.readyState)throw Error(t.error.invalidStateNotOpen);if(this._send)throw Error(t.error.invalidStateNotSending);f=g.parse(this._params.url);f.port=f.port||("https:"===f.protocol?443:80);null!==this._params.user&&null!==this._params.password&&(f.auth=this._params.user+":"+this._params.password);s.put_post.test(this._params.method)&&(this._headers["Content-Length"]=null!==a?Buffer.byteLength(a):0);this._headers.Host=f.hostname+(s.http_ports.test(f.port)?
...
function(a,b){if(1!==this.readyState)throw Error(t.error.invalidStateNotUsable);if(this._send)throw Error(t.error.invalidStateNotSending);this._headers[a]=b;return this};return b},P={decode:function(){return w||!q.ie||8<q.version?function(a){if("string"!==typeof a||l.isEmpty(a))throw Error(t.error.invalidArguments);return(new DOMParser).parseFromString(a,"text/xml")}:function(a){var b;if("string"!==typeof a||l.isEmpty(a))throw Error(t.error.invalidArguments);b=new ActiveXObject("Microsoft.XMLDOM");
b.async="false";b.loadXML(a);return b}}(),encode:function(a,b){try{if(void 0===a)throw Error(t.error.invalidArguments);var c=(b=!1!==b)?"<xml>":"",d=!1!==arguments[2],e;e=function(a,b){var c;c="<n>v</n>".replace("v",s.cdata.test(b)?"<![CDATA["+b+"]]\x3e":b);return c.replace(/<(\/)?n>/g,"<$1"+a+">")};null!==a&&void 0!==a.xml&&(a=a.xml);a instanceof Document&&(a=(new XMLSerializer).serializeToString(a));s.boolean_number_string.test(typeof a)?c+=e("item",a):"object"===typeof a&&g.iterate(a,function(a,
...
"POST",b,c,d,e,f)},put:function(a,b,c,d,e,f){return q.request(a,"PUT",b,c,d,e,f)},jsonp:function(a,b,c,d){return q.jsonp(a,b,c,d)},options:function(a,b,c,d){return q.request(a,"OPTIONS",b,c,null,null,d)},permissions:q.permissions},cookie:fa,element:h,json:H,label:t,loading:{create:g.loading,url:null},message:{clear:function(a){return m.remove(D,"message","message",a||"all")},send:function(a,b){try{a.postMessage(b,"*")}catch(c){g.error(c,arguments,this)}return a},recv:function(a,b){return m.add(D,
"message",a,"message",D,b||"all")}},mouse:G,number:u,regex:s,route:{enabled:!1,current:v.current,del:v.del,hash:v.hash,init:v.init,initial:v.initial,list:v.list,load:v.load,reset:v.reset,server:v.server,set:v.set},state:{},string:l,xml:P,alias:g.alias,aliased:"abaaso",allows:q.allows,append:function(a,b,c){c instanceof Element&&c.genId();return h.create(a,b,c,"last")},bootstrap:function(){var a=this,b,c;b=function(a){m.remove(a);f.each(f.cast(a.childNodes),function(a){b(a)})};c=function(){if(s.complete_loaded.test(x.readyState))return"function"===
typeof a.init&&a.init.call(a),!1};delete this.bootstrap;this.error.log=[];z.delay=z.delay();if(w)this.array.cast=f.cast(),this.property=g.property=g.property(),XMLHttpRequest=ia();else{this.client.size=q.size();this.client.version=q.version=q.version();this.client.mobile=q.mobile.call(this);this.client.tablet=q.tablet.call(this);if(q.ie&&8>q.version)throw Error(t.error.upgrade);this.array.cast=f.cast();this.mouse.view=G.view();this.property=g.property=g.property();void 0===Array.prototype.filter&&
...
}(D);void 0===Function.prototype.bind&&(Function.prototype.bind=function(a){var b=this,c=Array.prototype.slice,f=c.call(arguments,1);return function(){return b.apply(a,f.concat(c.call(arguments)))}})}B=g.$;g.merge(B,this);delete B.init;delete B.loading;v.reset();g.proto(Array,"array");"undefined"!==typeof Element&&g.proto(Element,"element");q.ie&&8===q.version&&g.proto(HTMLDocument,"element");g.proto(Function,"function");g.proto(Number,"number");g.proto(String,"string");w||(m.add(D,"error",function(a){m.fire(M,
"error",a)},"error",D,"all"),m.add(D,"hashchange",function(){var b=O.hash.replace(/^\#\!?|\?.*|\#.*/g,"");if(B.route.current!==b||a.route.current!==b)a.route.current=b,B.route.current!==a.route.current&&(B.route.current=a.route.current),m.fire(M,"beforeHash, hash, afterHash",O.hash)},"hash",D,"all"),m.add(D,"resize",function(){B.client.size=a.client.size=q.size();m.fire(M,"resize",a.client.size)},"resize",D,"all"),m.add(D,"load",function(){m.fire(M,"render");m.remove(M,"render");m.remove(this,"load")}),
"function"===typeof Object.observe&&m.add(D,"DOMNodeInserted",function(a){var b=g.target(a);Object.observe(b,function(a){m.fire(b,"change",a)})},"mutation",D,"all"),m.add(D,"DOMNodeRemoved",function(a){var c=g.target(a);void 0!==c.id&&(!l.isEmpty(c.id)&&a.relatedNode instanceof Element)&&b(c)},"mutation",D,"all"),m.add(M,"hash",function(b){(B.route.enabled||a.route.enabled)&&v.load(b)},"route",this.route,"all"));!q.ie||8<q.version?(g.property(this.state,"current",{enumerable:!0,get:F.getCurrent,set:F.setCurrent}),
