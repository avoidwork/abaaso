...
b&&p.is_xml.test(a.responseText)&&Q.valid(a.responseText)?Q.decode(a.responseText):a.responseText);return c},permissions:function(a){a=(a=y.get(a,!1))?a.permission:0;var b={allows:[],bit:a,map:{partial:8,read:4,write:2,"delete":1,unknown:0}};a&1&&b.allows.push("DELETE");a&2&&(b.allows.push("POST"),b.allows.push("PUT"));a&4&&b.allows.push("GET");a&8&&b.allows.push("PATCH");return b},jsonp:function(a,b,c,d){var g=F(),e="callback",q,da;void 0===W&&(void 0===A.abaaso&&h.define("abaaso.callback",{},A),
W="abaaso");d instanceof Object&&void 0!==d.callback&&(e=d.callback);g.then(function(a){"function"===typeof b&&b(a)},function(a){"function"===typeof c&&c(a);throw a;});do q=h.genId().slice(0,10);while(void 0!==A.abaaso.callback[q]);a=a.replace(e+"=?",e+"="+W+".callback."+q);A.abaaso.callback[q]=function(a){clearTimeout(h.timer[q]);delete h.timer[q];delete A.abaaso.callback[q];g.resolve(a);f.destroy(da)};da=f.create("script",{src:a,type:"text/javascript"},h.dom("head")[0]);h.defer(function(){g.reject(void 0)},
3E4,q);return g},request:function(a,b,c,d,g,e,q){q=q||3E4;var f,n,P,k,l,m,Y,r,w;if(p.put_post.test(b)&&void 0===g)throw Error(u.error.invalidArguments);a=h.parse(a).href;b=b.toLowerCase();e=e instanceof Object?e:null;f=s.cors(a);n=s.ie&&"patch"===b?new ActiveXObject("Microsoft.XMLHTTP"):new XMLHttpRequest;g=(p.put_post.test(b)||p.patch.test(b))&&void 0!==g?g:null;P="get"===b?y.get(a):!1;k=b.capitalize();l=null;m="undefined"!==typeof Document;Y="undefined"!==typeof ArrayBuffer;r="undefined"!==typeof Blob;
w=F();w.then(function(b){"function"===typeof c&&c.call(a,b,n);n=null},function(b){"function"===typeof d&&d.call(a,b,n);n=null;throw b;});a.fire("before"+k);if(!f&&!p.get_headers.test(b)&&!1===s.allows(a,b))return n.status=405,w.reject(null),a.fire("failed"+k,null,n);if("get"===b&&Boolean(P))v&&(n.readyState=4,n.status=200,n._resheaders=P.headers),w.resolve(P.response),a.fire("afterGet",P.response,n);else{n["undefined"!==typeof n.onreadystatechange?"onreadystatechange":"onload"]=function(){s.response(n,
a,b,w)};try{void 0!==n.timeout&&(n.timeout=q)}catch(x){}void 0!==n.ontimeout&&(n.ontimeout=function(b){a.fire("timeout"+k,b,n)});void 0!==n.onprogress&&(n.onprogress=function(b){a.fire("progress"+k,b,n)});void 0!==n.upload&&void 0!==n.upload.onprogress&&(n.upload.onprogress=function(b){a.fire("progressUpload"+k,b,n)});n.open(b.toUpperCase(),a,!0);null!==e&&e.hasOwnProperty("Content-Type")&&(l=e["Content-Type"]);f&&null===l&&(l="text/plain");null!==g&&(g.hasOwnProperty("xml")&&(g=g.xml),m&&g instanceof
Document&&(g=Q.decode(g)),"string"===typeof g&&p.is_xml.test(g)&&(l="application/xml"),Y&&g instanceof ArrayBuffer||(r&&g instanceof Blob||!(g instanceof Object))||(l="application/json",g=B.encode(g)),null===l&&(Y&&g instanceof ArrayBuffer||r&&g instanceof Blob)&&(l="application/octet-stream"),null===l&&(l="application/x-www-form-urlencoded; charset=UTF-8"));"undefined"!==typeof n.setRequestHeader&&("object"===typeof P&&P.headers.hasOwnProperty("ETag")&&n.setRequestHeader("ETag",P.headers.ETag),null===
e&&(e={}),null!==l&&(e["Content-Type"]=l),e.hasOwnProperty("callback")&&delete e.callback,h.iterate(e,function(a,b){null!==a&&"withCredentials"!==b&&n.setRequestHeader(b,a)}));"boolean"===typeof n.withCredentials&&(null!==e&&"boolean"===typeof e.withCredentials)&&(n.withCredentials=e.withCredentials);null!==g?n.send(g):n.send()}return w},response:function(a,b,c,d){var g=m.capitalize(c.toLowerCase()),e=null,q=!0,f,n,k;f=function(a,c){d.reject(a);h.error(a,arguments,this,!0);b.fire("failed"+g,s.parse(c),
...
z.prototype.sort=function(a,b,c){b=!0===b||c instanceof Object;var d=this,g=m.explode(a).join(" ").toCamelCase(),f=F(),h,k,n;k=function(c){0===d.total?f.resolve([]):!b&&d.views[g]?f.resolve(d.views[g]):v?(d.views[g]=e.keySort(c.slice(),a,"data"),f.resolve(d.views[g])):(h=new Blob([decodeURIComponent(V)]),n=new Worker(A.URL.createObjectURL(h)),n.onmessage=function(a){d.views[g]=a.data;f.resolve(d.views[g])},n.postMessage({cmd:"sort",records:c.slice(),query:a}))};c?this.select(c).then(k):k(this.records);
return f};z.prototype.storage=function(a,b,c){var d=this,g=!1,f=!m.isEmpty(this.mongodb);c="session"===c&&"undefined"!==typeof sessionStorage;var q=F(),k,n;if(!p.number_string_object.test(typeof a)||!p.get_remove_set.test(b))throw Error(u.error.invalidArguments);g=p.number_string.test(typeof a)||a.hasOwnProperty("key")&&!a.hasOwnProperty("parentNode");"remove"!==b?(!g||a instanceof Object||(a=this.get(a)),n=g?a.key:a.parentNode.id):"remove"===b&&g&&(n=a.key||a);"get"===b?f?mongodb.connect(this.mongodb,
function(b,c){b?(q.reject(b),c.close()):c.createCollection(d.parentNode.id,function(b,e){b?(q.reject(b),c.close()):g?e.find({_id:a.key}).limit(1).toArray(function(a,b){a?q.reject(a):(delete b[0]._id,d.set(n,b[0],!0).then(function(a){q.resolve(a)},function(a){q.reject(a)}));c.close()}):e.find({}).toArray(function(a,b){var g=-1,e=b.length;a?q.reject(a):(0<e&&(d.records=b.map(function(a){var b={key:a._id,index:++g,data:{}};d.keys[b.key]=b.index;b.data=a;delete b.data._id;return b}),d.total=e),q.resolve(d.records));
...
z.prototype.update=function(a,b){var c=this.get(a),d=F();if(void 0===c)throw Error(u.error.invalidArguments);h.iterate(c.data,function(a,c){b[a]=c});this.set(a,b).then(function(a){d.resolve(a)},function(a){d.reject(a)});return d};var U={factory:function(a,b,c,d){var g=[b];if(!(a instanceof Element&&"object"===typeof b&&p.string_object.test(typeof c)))throw Error(u.error.invalidArguments);a=f.create("ul",{"class":"list",id:b.parentNode.id+"-datalist"},a);c=new J(a,g[0],c);d instanceof Object&&h.merge(c,
...
e.each(h.dom("input[name='"+a.name+"']"),function(a){if(a.checked)return d=a.value,!1})}else d=p.select.test(a.type)?a.options[a.selectedIndex].value:X.call(a,"value")?a.value:f.text(a);void 0!==d&&(d=h.coerce(d));"string"===typeof d&&(d=m.trim(d))}else b=b.toString(),p.radio_checkbox.test(a.type)?(c="click",e.each(h.dom("input[name='"+a.name+"']"),function(a){if(a.value===b)return a.checked=!0,d=a,!1})):p.select.test(a.type)?(c="change",e.each(f.find(a,"> *"),function(a){if(a.value===b)return a.selected=
!0,d=a,!1})):void 0!==a.value?a.value=b:f.text(a,b),f.dispatch(a,c),d=a;return d},validate:function(a){return"FORM"===a.nodeName?H.test(a):!m.isEmpty(a.value||f.text(a))}},fa=function(a,b,c,d){d=d||250;var e=[b];if(!(a instanceof Element)||void 0!==b&&void 0===b.store||"string"!==typeof c||m.isEmpty(c))throw Error(u.error.invalidArguments);return(new R(a,e[0],d)).set(c).init()};R.prototype.constructor=R;R.prototype.init=function(){k.add(this.element,"keyup",this.update,"filter",this);k.add(this.element,
"input",this.update,"value",this);return this};R.prototype.set=function(a){var b={};e.each(m.explode(a),function(a){b[a]=""});this.filters=b;return this};R.prototype.teardown=function(){k.remove(this.element,"keyup","filter");k.remove(this.element,"input","value");return this};R.prototype.update=function(){var a=this;h.defer(function(){var b=f.val(a.element);m.isEmpty(b)?a.datalist.filter=null:(h.iterate(a.filters,function(a,d){var g=m.explode(b),g=g.filter(function(a){return!m.isEmpty(a)});e.each(g,
...
a&&(this.last=b.next));return b};S.prototype.set=function(a,b){var c=this.remove(a);void 0===c?c=new M(b):c.value=b;c.next=null;c.previous=this.first;this.cache[a]=c;null!==this.first&&(this.cache[this.first].next=a);this.first=a;null===this.last&&(this.last=a);++this.length>this.max&&this.evict();return this};M.prototype.constructor=M;var K={bezier:function(){var a=e.cast(arguments),b=a.pop(),a=e.chunk(a,2),c=a.length,d,g,f,h,k,n,l,m,p;if(2>c||4<c)throw Error(u.error.invalidArguments);d=[];g=1-b;
...
c.auth?"":c.auth[1]);c.href=b.href||c.protocol+"//"+(m.isEmpty(c.auth)?"":c.auth+"@")+c.host+c.pathname+c.search+c.hash;c.path=b.path||c.pathname+c.search;c.query=h.queryString(null,c.search);return c},property:function(a,b,c){if(!(c instanceof Object))throw Error(u.error.invalidArguments);void 0!==c.value&&void 0!==c.get&&delete c.value;Object.defineProperty(a,b,c);return a},proto:function(a,b){var c=a.prototype||a;h.iterate(ha[b],function(a,b){c[b]||h.property(c,b,{value:a,configurable:!0,writable:!0})});
...
function(){if(p.complete_loaded.test(x.readyState))return c(),!1};c=function(){h.repeat(function(){y.clean()},6E4,"cacheGarbageCollector");k.fire("abaaso","init, ready");k.remove("abaaso","init, ready")};h.error.log=[];if(v)XMLHttpRequest=ia();else if(l.client.version=s.version=s.version(),l.client.mobile=s.mobile=s.mobile.call(this),l.client.tablet=s.tablet=s.tablet.call(this),s.ie&&10>s.version)throw Error(u.error.upgrade);X=Object.prototype.hasOwnProperty;ea=Array.prototype.slice;v||(k.add(A,"error",
