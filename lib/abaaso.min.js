...
ba;var G={csv:function(a,b,c){b=b||",";c=!1!==c;a=G.decode(a,!0)||a;var d="",e;e=function(a){var c;a instanceof Array?(c='"'+a.toString()+'"',r.object_type.test(c)&&(c='"'+G.encode(a)+'"')):c=a instanceof Object?'"'+G.encode(a)+'"':r.csv_quote.test(a)?'"'+a.replace(/\n/g," ").replace(/"/g,'""')+'"':a;return c};a instanceof Array?(c&&(d=g.keys(a[0]).join(b)+"\n"),d+=a.map(function(a){return G.csv(a,b,!1)}).join("\n")):(c&&(d=g.keys(a).join(b)+"\n"),d+=g.cast(a).map(e).join(b)+"\n");return d.replace(/\n$/,
...
a,b,c)},update:l.update,uuid:h.uuid,validate:J.test,version:"3.7.13",walk:h.walk,when:h.when}}(),O=H.bootstrap(),"undefined"!==typeof exports?module.exports=O:"function"===typeof define?define("abaaso",function(){return O}):D.abaaso=O)})(this);
